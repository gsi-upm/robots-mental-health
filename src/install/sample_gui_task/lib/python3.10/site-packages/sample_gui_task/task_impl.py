...
class TaskImpl(Node):
    """
    Implementation of task sample_gui_task.
    ...
    def __init__(self) -> None:
        """Construct the node."""
        super().__init__('task_sample_gui_task')
        ...
        self.get_logger().info('Task sample_gui_task started, but not yet configured.')
    ...
    def on_ui_msg(self, msg: String) -> None:
        ...
        Every time a message is received on the topic /sample_gui_task/ui_msg,
    ...
    def set_ui(self, qml: str) -> None:
        ...
        ui_fragment.qml_import_path = get_package_share_directory("sample_gui_task") + "/.."
        ui_fragment.qml_fragment = "import sample_gui_task.ui 1.0\n" + qml
    ...
    def on_configure(self, state: State) -> TransitionCallbackReturn:
        ...
        self.task_server = ActionServer(
            self, TaskControl, "/sample_gui_task/control",
            goal_callback=self.on_request_goal,
            execute_callback=self.on_request_exec)

        self.get_logger().info("Task sample_gui_task is configured, but not yet active")
    ...
    def on_activate(self, state: State) -> TransitionCallbackReturn:
        ...
        self._task_progress_pub = self.create_publisher(Int16,
                                                        '/sample_gui_task/task_progress', 10)
        ...
        self.get_logger().info("Task sample_gui_task is active and running")
    ...
    def on_deactivate(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Task sample_gui_task is stopped (inactive)")
    ...
    def on_shutdown(self, state: State) -> TransitionCallbackReturn:
        ...
        :return: The state machine either invokes a transition to the
            ...
            "errorprocessing"
        """
        self.get_logger().info('Shutting down task sample_gui_task.')
        self.destroy_timer(self._diag_timer)
        self.destroy_publisher(self._diag_pub)

        self.destroy_timer(self._timer)

        self.get_logger().info("Task sample_gui_task finalized.")
        return TransitionCallbackReturn.SUCCESS
    ...
    def publish_diagnostics(self):
        ...
        msg = DiagnosticStatus(
            ...
            name="/task_sample_gui_task",
            message="task sample_gui_task is running",
            values=[
                KeyValue(key="Module name", value="sample_gui_task"),
